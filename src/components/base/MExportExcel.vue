...
export default {
  ...
  methods: {
    async generate() {
      ...
      let header = this.downloadFields;
      let json = this.getProcessedJson(data, header);
      if (this.type === "html") {
        // this is mainly for testing
        return this.export(
          this.jsonToXLS(header, json),
    ...
    jsonToXLS(header, data) {
      ...
      for (let key in header) {
        if (header[key].fieldName)
          xlsData += "<th>" + header[key].fieldName + "</th>";
        else if (key) xlsData += "<th>" + key + "</th>";
      }
      xlsData += "</tr>";
      xlsData += "</thead>";
